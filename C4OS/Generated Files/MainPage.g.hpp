...
void ::C4OS::MainPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::C4OS::MainPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::C4OS::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
